<div class="content-wrapper">   
    ...
    <section class="content">
        <div class="row">
            <?php
            if ($this->rbac->hasPrivilege('batch', 'can_add') || $this->rbac->hasPrivilege('batch', 'can_edit')) {
                ?>
                <div class="col-md-4">
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title"><?php echo $this->lang->line('edit'); ?> <?php echo $this->lang->line('batch'); ?></h3>
                        </div>
                        <form action="<?php echo site_url("batches/edit/" . $id) ?>"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8">
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input autofocus="" id="batch" name="batch" placeholder="" type="text" class="form-control"  value="<?php echo set_value('batch', $batch['batch']); ?>" />
