...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="row">
            <?php if ($this->rbac->hasPrivilege('add_event', 'can_add') || $this->rbac->hasPrivilege('add_event', 'can_edit')) { ?>
                <div class="col-md-4">
                    <!-- Horizontal Form -->
                    <div class="box box-primary">
                        ...
                        <form id="form1" action="<?php echo base_url() ?>admin/event/edit/<?php echo $event['id'] ?>"  id="eventform" name="eventform" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input autofocus="" id="event_name" name="event_name" placeholder="" type="text" class="form-control"  value="<?php echo set_value('event_name', $event['event_name']); ?>" />
                                ...
                                <div class="form-group">
                                    ...
                                    <input autofocus="" id="in_charge" name="in_charge" placeholder="" type="text" class="form-control"  value="<?php echo set_value('in_charge', $event['in_charge']); ?>" />
                                ...
                                <div class="form-group">
                                    ...
                                    <select autofocus="" id="committee_id" name="committee_id" class="form-control" >
                                        ...
                                        foreach ($committeelist as $committee) {
                                            ...
                                            if (set_value('committee_id', $event['committee_id']) == $committee['id']) {
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="description" name="description" placeholder="" rows="3" placeholder="Enter ..."><?php echo set_value('description', $event['description']); ?></textarea>
                                    <span class="text-danger"></span>
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputEmail1"><?php echo $this->lang->line('date_of_the_event_from_to'); ?></label>
                                    <input id="date" name="date" placeholder="" type="text" class="form-control"  value="<?php echo set_value('date', date($this->customlib->getSchoolDateFormat(), $this->customlib->dateyyyymmddTodateformat($event['date']))); ?>" readonly="readonly" />
            ...
            if ($this->rbac->hasPrivilege('add_event', 'can_add') || $this->rbac->hasPrivilege('add_event', 'can_edit')) {
                echo "8";
            } else {
                echo "12";
            }
