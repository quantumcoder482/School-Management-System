...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="row">
            <?php if ($this->rbac->hasPrivilege('e_resources', 'can_add')) { ?>
                <div class="col-md-4">

                    <!-- Horizontal Form -->
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title"><?php echo $this->lang->line('add_e_resource'); ?></h3>
                        </div><!-- /.box-header -->

                        <form id="form1" action="<?php echo base_url() ?>admin/eresource"  id="documentform" name="documentform" method="post" accept-charset="utf-8" enctype="multipart/form-data">
            ...
            if ($this->rbac->hasPrivilege('e_resources', 'can_add')) {
                echo "8";
            } else {
                echo "12";
            }
                    ...
                    <div class="box-body">
                        <div class="table-responsive mailbox-messages">
                            ...
                            <table class="table table-hover table-striped table-bordered example">
                                ...
                                <tbody>
                                    <?php
                                    if (empty($eresource_list)) {
                                        ?>

                                        <?php
                                    } else {
                                        foreach ($eresource_list as $eresource) {
                                            ?>
                                            <tr>
