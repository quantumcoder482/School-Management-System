...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="row">
            <?php if ($this->rbac->hasPrivilege('admin_document', 'can_add') || $this->rbac->hasPrivilege('admin_document', 'can_edit')) { ?>
                <div class="col-md-4">
                    <!-- Horizontal Form -->
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title"><?php echo $this->lang->line('edit_document'); ?></h3>
                        </div><!-- /.box-header -->
                        <form id="form1" action="<?php echo base_url() ?>admin/admindocument/edit/<?php echo $document['id'] ?>"  id="meetingform" name="meetingform" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input autofocus="" id="document_title" name="document_title" placeholder="" type="text" class="form-control"  value="<?php echo set_value('document_title', $document['document_title']); ?>" />
                                ...
                                <div class="form-group">
                                    ...
                                    <input autofocus="" id="document_no" name="document_no" placeholder="" type="text" class="form-control"  value="<?php echo set_value('document_no', $document['document_no']); ?>" />
                                ...
                                <div class="form-group">
                                    ...
                                    <select autofocus="" id="category_id" name="category_id" class="form-control" >
                                        ...
                                        foreach ($categorylist as $category) {
                                            ...
                                            if (set_value('category_id', $document['category_id']) == $category['id']) {
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="description" name="description" placeholder="" rows="3" placeholder="Enter ..."><?php echo set_value('description', $document['description']); ?></textarea>
            ...
            if ($this->rbac->hasPrivilege('admin_document', 'can_add') || $this->rbac->hasPrivilege('admin_document', 'can_edit')) {
                echo "8";
            } else {
                echo "12";
            }
