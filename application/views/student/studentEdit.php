                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input id="hall_no" name="hall_no" placeholder="" type="text" class="form-control" value="<?php echo set_value('hall_no', $student['hall_no']); ?>" />
                                        ...
                                        <div class="col-md-2">
                                            ...
                                            <div class="radio" style="margin-top: 2px;">
                                                <label><input class="radio-inline" type="radio" name="physically_challenged" value="Yes" <?php
                                                                                                                                            echo set_value('physically_challenged', $student['physically_challenged']) == "Yes" ? "checked" : "";
                                                                                                                                            ?>><?php echo $this->lang->line('yes'); ?></label>
                                                <label><input class="radio-inline" type="radio" name="physically_challenged" value="No" <?php
                                                                                                                                        echo set_value('physically_challenged', $student['physically_challenged']) == "No" ? "checked" : "";
                                                                                                                                        ?>><?php echo $this->lang->line('no'); ?></label>
                                            </div>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        var batch_id = '<?php echo set_value('batch_id', $student['batch_id']) ?>';
