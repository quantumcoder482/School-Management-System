                            ...
                            <div class="tshadow mb25 bozero">
                                ...
                                <div class="around10">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label for="exampleInputEmail1"><?php echo $this->lang->line('hall_no'); ?></label>
                                                <input id="hall_no" name="hall_no" placeholder="" type="text" class="form-control" value="<?php echo set_value('hall_no'); ?>" />
                                                <span class="text-danger"><?php echo form_error('hall_no'); ?></span>
                                            </div>
                                        </div>
                                        <div class="col-md-2">
                                            <div class="form-group">
                                    ...
                                    <div class="box-body">
                                        ...
                                        <div class="tshadow mb25 bozero">
                                            ...
                                            <div class="row around10">
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label for="exampleInputEmail1">
                                                            <?php echo $this->lang->line('adhar_no'); ?>
                                                        </label>
                                                ...
                                                <div class="col-md-2">
                                                    <label><?php echo $this->lang->line('physically_challenged'); ?></label>
                                                    <div class="radio" style="margin-top: 2px;">
                                                        <label><input class="radio-inline" type="radio" name="physically_challenged" value="Yes" <?php
                                                                                                                                                    echo set_value('physically_challenged') == "Yes" ? "checked" : "";
                                                                                                                                                    ?>><?php echo $this->lang->line('yes'); ?></label>
                                                        <label><input class="radio-inline" checked="checked" type="radio" name="physically_challenged" value="No" <?php
                                                                                                                                                                    echo set_value('physically_challenged') == "No" ? "checked" : "";
                                                                                                                                                                    ?>><?php echo $this->lang->line('no'); ?></label>
                                                    </div>
                                                    <span class="text-danger"><?php echo form_error('physically_challenged'); ?></span>
                                                </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control" id="mentor" name="mentor">
                                                            ...
                                                            foreach ($mentorlist as $key => $mentor_value) {
                                                                ...
                                                                <option value="<?php echo $mentor_value['id'] ?>" <?php echo set_select('mentor', $mentor_value['id']); ?>>
                                                                    <?php
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="tshadow bozero">
                                                        <div class="pull-right box-tools" style="position:absolute; right:29px; top:8px;">
                                                            <a id="add_document"><i class="fa fa-fw fa-plus"></i></a>
                                                        </div>
                                                            ...
                                                            <div class="col-md-6">
                                                                <table class="table">
                                                                    <tbody>
                                                                        ...
                                                                        <tr id="doc_add_1" style="display:none">
                                                                            <td>5.</td>
                                                                        ...
                                                                        <tr id="doc_add_3" style="display:none">
                                                                            <td>7.</td>
                                                                            <td><input type="text" name='seventh_title' class="form-control" placeholder=""></td>
                                                                            <td>
                                                                                <input class="filestyle form-control" type='file' name='seventh_doc' id="doc1">
                                                                            </td>
                                                                        </tr>
                                                                        <tr id="doc_add_5" style="display:none">
                                                                            <td>9.</td>
                                                                            <td><input type="text" name='nineth_title' class="form-control" placeholder=""></td>
                                                                            <td>
                                                                                <input class="filestyle form-control" type='file' name='nineth_doc' id="doc1">
                                                                            </td>
                                                                        </tr>
                                                                    </tbody>
                                                                </table>
                                                            ...
                                                            <div class="col-md-6">
                                                                <table class="table">
                                                                    <tbody>
                                                                        ...
                                                                        <tr id="doc_add_2" style="display:none">
                                                                            <td>6.</td>
                                                                            <td><input type="text" name='sixth_title' class="form-control" placeholder=""></td>
                                                                            <td>
                                                                                <input class="filestyle form-control" type='file' name='sixth_doc' id="doc1">
                                                                            </td>
                                                                        </tr>
                                                                        <tr id="doc_add_4" style="display:none">
                                                                            <td>8.</td>
                                                                            <td><input type="text" name='eighth_title' class="form-control" placeholder=""></td>
                                                                            <td>
                                                                                <input class="filestyle form-control" type='file' name='eighth_doc' id="doc1">
                                                                            </td>
                                                                        </tr>
                                                                        <tr id="doc_add_6" style="display:none">
                                                                            <td>10.</td>
                                                                            <td><input type="text" name='tenth_title' class="form-control" placeholder=""></td>
                                                                            <td>
                                                                                <input class="filestyle form-control" type='file' name='tenth_doc' id="doc1">
                                                                            </td>
                                                                        </tr>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        getBatchBySection(section_id, batch_id);
        ...
        $("#add_document").click(function() {
            doc_number += 1;
            if (doc_number <= 10) {
                $("#doc_add_" + doc_number).removeAttr('style');
            }
