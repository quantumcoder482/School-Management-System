                                    ...
                                    <div class="cardright">
                                        <ul class="stlist">
                                            ...
                                            if ($idcardlist[0]->enable_student_name == 1) {
                                                echo "<li>Student Name<span>" . $resultlist[0]['firstname'] . ' ' . $resultlist[0]['lastname'] . "</span></li>";
                                            }
                                            ?>
                                            <?php
                                            if ($idcardlist[0]->enable_class == 1) {
                                                echo "<li>Class<span>" . $resultlist[0]['class'] . " - " . $resultlist[0]['section'] . "</span></li>";
                                            }
                                            ?>
                                            <?php
                                            if ($idcardlist[0]->enable_fathers_name == 1) {
                                                echo "<li>Father's Name<span>" . $resultlist[0]['father_name'] . " </span></li>";
                                            }
                                            ?>
                                            <?php
                                            if ($idcardlist[0]->enable_mothers_name == 1) {
                                                echo "<li>Mothers's Name<span>" . $resultlist[0]['mother_name'] . " </span></li>";
                                            }
                                            ?>
                                            <?php
                                            if ($idcardlist[0]->enable_address == 1) {
                                                echo "<li>Address<span>" . $resultlist[0]['permanent_address'] . " </span></li>";
                                            }
                                            ?>
                                            <?php
                                            if ($idcardlist[0]->enable_phone == 1) {
                                                echo "<li>Phone<span>" . $resultlist[0]['father_phone'] . " </span></li>";
                                            }
                                            ?>
                                            <?php
                                            if ($idcardlist[0]->enable_dob == 1) {
                                                echo "<li>D.O.B<span>" . date('d-m-Y', strtotime($resultlist[0]['dob'])) . " </span></li>";
                                            }
                                            ?>
                                            <?php
