                                            ...
                                            <div class="cardright">
                                                <ul class="stlist">
                                                    ...
                                                    if ($idcardlist[0]->enable_admission_no == 1) {
                                                        echo "<li>Admission Number<span>" . $list[0]['admission_no'] . " </span></li>";
                                                    }
                                                    ?>
                                                    <?php
                                                    if ($idcardlist[0]->enable_student_name == 1) {
                                                        echo "<li>Student Name<span>" . $list[0]['firstname'] . ' ' . $list[0]['lastname'] . "</span></li>";
                                                    }
                                                    ?>
                                                    <?php
                                                    if ($idcardlist[0]->enable_class == 1) {
                                                        echo "<li>Class<span>" . $list[0]['class'] . " - " . $list[0]['section'] . "</span></li>";
                                                    }
                                                    ?>
                                                    <?php
                                                    if ($idcardlist[0]->enable_fathers_name == 1) {
                                                        echo "<li>Father's Name<span>" . $list[0]['father_name'] . " </span></li>";
                                                    }
                                                    ?>
                                                    <?php
                                                    if ($idcardlist[0]->enable_mothers_name == 1) {
                                                        echo "<li>Mothers's Name<span>" . $list[0]['mother_name'] . " </span></li>";
                                                    }
                                                    ?>
                                                    <?php
                                                    if ($idcardlist[0]->enable_address == 1) {
                                                        echo "<li>Address<span>" . $list[0]['permanent_address'] . " </span></li>";
                                                    }
                                                    ?>
                                                    <?php
                                                    if ($idcardlist[0]->enable_phone == 1) {
                                                        echo "<li>Phone<span>" . $list[0]['father_phone'] . " </span></li>";
                                                    }
                                                    ?>
                                                    <?php
                                                    if ($idcardlist[0]->enable_dob == 1) {
                                                        echo "<li>D.O.B<span>" . date('d-m-Y', strtotime($list[0]['dob'])) . " </span></li>";
                                                    }
                                                    ?>
                                                    <?php
                                                    if ($idcardlist[0]->enable_blood_group == 1) {
                                                        echo "<li class='stred'>Blood Group<span> A+ --r </span></li>";
                                                    }
                                                    ?>
                                                </ul>
                                            </div><!--./cardright-->
