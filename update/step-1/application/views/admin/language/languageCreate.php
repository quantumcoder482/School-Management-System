                    ...
                    <form id="form1" action="<?php echo site_url('admin/language/create') ?>"  id="employeeform" name="employeeform" class="form-horizontal form-label-left" method="post" accept-charset="utf-8">
                        <div class="box-body">  
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="exampleInputEmail1"><?php echo $this->lang->line('short')." ".$this->lang->line('code'); ?><small class="req">  *</small></label>
                                <div class="col-md-6 col-sm-6 col-xs-12">
